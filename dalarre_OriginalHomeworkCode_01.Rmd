...
## With this function, I split the vector in the different words and I call this new separate list w (I don't know why it is stored as a list and not as a vector), and I call "string" the only element in the list so i can refer to it later
