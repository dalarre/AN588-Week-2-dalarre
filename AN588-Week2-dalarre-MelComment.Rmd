---
title: "dalarre_FInalHomeworkCOde_01"
...
After peer commentary, I changed challenge 2 from the original because I saw on Zoe's code that there was a simpler way to do it. I didn't change the code on the other challenges because this is the best way I found to do them.
...
## After doing peer commentary and looking at Zoe's code, I realized that I could do this challenge in a simpler way than what I did on my original homework code, because I was creating vectors, which wasn't necessary, so I changed it here:

## This extracts the values of the 2nd, 3rd and 6th column of the matrix m and assings them to x
x <- m[,c(2,3,6)]
x

## This extracts the values from the 6th to the 8th row of the matrix m and assings them to y
y <- m[6:8,]
y

## This extracts the elements from row 2, column 2 to row 6, column 9 of the matrix m and assings them to z
z <- m[2,2]:m[6,9]
z
```
...
*Great work all around! Looks like you figured out all of our problesm on your own.-Mel*