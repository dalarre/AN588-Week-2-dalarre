...
After peer commentary, I changed challenge 2 from the original because there was a simpler way to do it. I didn't change the code on the other challenges because this is the best way I found to do them.
...
## After doing peer commentary, I realized that I could do this challenge in a simpler way than what I did on my original homework code, so I changed it here:
